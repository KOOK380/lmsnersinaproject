...
sidebarCode = sidebarCode.replace('<div className="xl:col-span-1">', '<div className="xl:col-span-1 xl:row-span-2 w-full">');
...
// Clean up trailing divs issue left by removing sidebar
